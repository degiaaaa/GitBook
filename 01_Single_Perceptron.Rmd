...
You can see that its possible to split up the red points (equals $Y_i=1$) and the black point (equals $Y_i=0$) by a straight line. If this isnt possible, like in the XOR-Gate, the single Perceptron will never find a combination of bias and weights to perform good results. This is the reason why we need more layers, that is explanied in the Multy-Layer-perceptron chapter. [Here](https://towardsdatascience.com/how-neural-networks-solve-the-xor-problem-59763136bdd7) can you find a good source with more explanation.
