...
You can see that its possible to split up the red points (equals \(Y_i=1\)) and the black point (equals \(Y_i=0\)) by a straight line. If this isnt possible, like in the XOR-Gate, the single Perceptron will never find a combination of bias and weights to perform good results. This is the reason why we need more layers, that is explanied in the Multy-Layer-perceptron chapter. \href{https://towardsdatascience.com/how-neural-networks-solve-the-xor-problem-59763136bdd7}{Here} can you find a good source with more explanation.
...
\begin{verbatim}
## W[0]: 
##  [[0.51295449 0.78286829]
##  [0.42002861 0.30162088]
##  [0.82217338 0.25291501]]
## W[1]: 
##  [[0.61536496]
##  [0.71361394]
##  [0.54295171]]
...
\begin{verbatim}
## Time to train the NN:  8.247204542160034
\end{verbatim}
...
\begin{verbatim}
## Time to train the NN:  23.291285514831543
\end{verbatim}
